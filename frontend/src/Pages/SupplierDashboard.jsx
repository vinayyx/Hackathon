...
const SupplierDashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/suppliers/${supplierId}/orders`);
        if (res.ok) {
  ...
  const updateOrderStatus = async (id, newStatus) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/suppliers/orders/${id}`, {
        method: "PATCH",
  ...
  const handleItemUpload = async () => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/suppliers/${supplierId}/items`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
